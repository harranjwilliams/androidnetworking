...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject rootNode = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray featuresArray = rootNode.getJSONArray("features");
            for (int i = 0; i < featuresArray.length(); i++) {
                JSONObject earthquakeObj = (JSONObject) featuresArray.get(i);
